...
function bsc_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'bsc' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'bsc_custom_background_args', array(
...
function bsc_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bsc' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bsc' ),
